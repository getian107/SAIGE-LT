...
option_list <- list(
 ...
 make_option("--entryTimeCol", type="character", default="",
    help="for survival analysis with left truncation, column name for entry time in the phenotype file, e.g entryTime. If not specified, no left truncation is assumed"),
